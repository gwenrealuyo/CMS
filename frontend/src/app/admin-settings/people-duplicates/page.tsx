...
export default function PeopleDuplicatesPage() {
  return (
    <ProtectedRoute allowedRoles={["ADMIN"]}>
      <PeopleDuplicatesPageContent />
    </ProtectedRoute>
  );
}

function PeopleDuplicatesPageContent() {
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Review people who share the same first and last name, or the same
            LAMP ID. This is an audit list only — it does not merge records.
          </p>
        </div>
