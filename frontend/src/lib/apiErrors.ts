...
const FIELD_LABELS: Record<string, string> = {
  ...
  hg_witnessed_by: "Witnessed by",
  baptized_by_id: "Baptized by",
  hg_witnessed_by_id: "Witnessed by",
  baptized_by_first_name: "Baptizer first name",
  baptized_by_last_name: "Baptizer last name",
  hg_witnessed_by_first_name: "Witness first name",
  hg_witnessed_by_last_name: "Witness last name",
  historical_verified_first_name: "First name",
  historical_verified_last_name: "Last name",
  verified_by: "Verified by",
  lessons_started_at: "Lessons started date",
  lessons_finished_at: "Lessons finished date",
  lesson_teacher_id: "Lessons teacher",
  historical_teacher_first_name: "Former teacher first name",
  historical_teacher_last_name: "Former teacher last name",
  status_change_reason: "Status reason",
